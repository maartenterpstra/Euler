...
mat = numpy.matrix([
    ...
    [19, 80, 81, 68, 0o5, 94, 47, 69, 28, 73,
...
for x in range(m):
    for y in range(n):
        right = mat[x, y] * mat[x, y + 1] * mat[x, y + 2] * \
            mat[x, y + 3] if y + 3 < 20 else -1
        down = mat[x, y] * mat[x + 1, y] * mat[x + 2, y] * \
            mat[x + 3, y] if x + 3 < 20 else -1
        up = mat[x, y] * mat[x, y - 1] * mat[x, y - 2] * \
            mat[x, y - 3] if y - 3 >= 0 else -1
        left = mat[x, y] * mat[x - 1, y] * mat[x - 2, y] * \
            mat[x - 3, y] if x - 3 >= 0 else -1
        diagDR = mat[x, y] * mat[x + 1, y + 1] * mat[x + 2, y + 2] * \
            mat[x + 3, y + 3] if x + 3 < 20 and y + 3 < 20 else -1
        diagUL = mat[x, y] * mat[x - 1, y - 1] * mat[x - 2, y - 2] * \
            mat[x - 3, y - 3] if x - 3 >= 0 and y - 3 >= 0 else -1
        diagDL = mat[x, y] * mat[x - 1, y + 1] * mat[x - 2, y + 2] * \
            mat[x - 3, y + 3] if x - 3 >= 0 and y + 3 < 20 else -1
        diagUR = mat[x, y] * mat[x + 1, y - 1] * mat[x + 2, y - 2] * \
            mat[x + 3, y - 3] if x + 3 < 20 and y - 3 >= 0 else -1
