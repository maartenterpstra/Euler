...
class Triangle:
	...
	def getSides(self):
		return [p1.distance(p2) for (p1, p2) in itertools.combinations([self.a, self.b, self.c], 2)]
...
origin = Point(0,0)
possibleTriangles = (Triangle(x,y,z) for (x, y, z) in itertools.combinations(points, 3) if x == origin and not InLine(x, y, z))
